...
<table class="table table-bordered table-hover table-striped"  style="background-color:rgba(237, 231, 225, 0.5);margin-top:50px" align="center" >
		...
		$sql="select*from customer_request,customer_registration where customer_registration.id=customer_request.customerid AND status='requested'";		$result=$conn->query($sql);
